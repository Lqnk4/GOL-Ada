...
package RaylibExtra is
   ...
   procedure Vector2Zero;
   pragma Import (C, Vector2Zero, "Vector2Zero");

   procedure Vector2One;
   pragma Import (C, Vector2One, "Vector2One");
   ...
   function Clamp
     (value : C_float; min : C_float; max : C_float) return C_float;
